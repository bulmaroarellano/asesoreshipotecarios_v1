<div>
    <div class="mb-4">
        @can('create', App\Models\Ingreso::class)
        <button class="btn btn-primary" wire:click="newIngreso">
            <i class="icon ion-md-add"></i>
            @lang('crud.common.new')
        </button>
        @endcan @can('delete-any', App\Models\Ingreso::class)
        <button
            ...
            <div class="modal-body">
                <div>
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.text
                            name="ingreso.empresa"
                            label="Empresa"
                            wire:model="ingreso.empresa"
                            maxlength="255"
                            placeholder="Empresa"
                        ></x-inputs.text>
                    </x-inputs.group>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="ingreso.comprobante_ingresos"
                            label="Comprobante Ingresos"
                            wire:model="ingreso.comprobante_ingresos"
                        >
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.text
                            name="ingreso.salario_bruto"
                            label="Salario Bruto"
                            wire:model="ingreso.salario_bruto"
                            maxlength="9"
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.text
                            name="ingreso.salario_neto"
                            label="Salario Neto"
                            wire:model="ingreso.salario_neto"
                            maxlength="9"
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="ingreso.tipo_empleo"
                            label="Tipo Empleo"
                            wire:model="ingreso.tipo_empleo"
                        >
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.date
                            name="ingresoFechaContratacion"
                            label="Fecha Contratacion"
                            wire:model="ingresoFechaContratacion"
                            max="255"
                        ></x-inputs.date>
                    </x-inputs.group>
                </div>
        ...
        <table class="table table-borderless table-hover">
            ...
            <tbody class="text-gray-600">
                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="text-left">{{ $ingreso->empresa ?? '-' }}</td>
                    <td class="text-left">
                        {{ $ingreso->comprobante_ingresos ?? '-' }}
                    </td>
                    <td class="text-left">
                        {{ $ingreso->salario_bruto ?? '-' }}
                    </td>
                    <td class="text-left">
                        {{ $ingreso->salario_neto ?? '-' }}
                    </td>
                    <td class="text-left">
                        {{ $ingreso->tipo_empleo ?? '-' }}
                    </td>
                    <td class="text-left">
                        {{ $ingreso->fecha_contratacion ?? '-' }}
                    </td>
            ...
            <tfoot>
                <tr>
                    <td colspan="7">{{ $ingresos->render() }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
